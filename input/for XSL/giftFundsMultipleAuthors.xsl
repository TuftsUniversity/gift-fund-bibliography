        ...
        <xsl:for-each select="record">
            ...
            <xsl:choose>
                <xsl:when test="datafield[@tag = '264' and @ind2 = '1']/subfield[@code = 'a']">
                        <xsl:value-of select="datafield[@tag = '264' and @ind2 = '1']/subfield[@code = 'a']"/>      
                </xsl:when>
            </xsl:choose>
            <xsl:text>~</xsl:text>
            <xsl:choose>
                <xsl:when test="datafield[@tag = '264' and @ind2 = '1']/subfield[@code = 'b']">
                        <xsl:value-of select="datafield[@tag = '264' and @ind2 = '1']/subfield[@code = 'b']"/>
                </xsl:when>
            </xsl:choose>
            <xsl:text>~</xsl:text>
            <xsl:choose>
                <xsl:when test="datafield[@tag = '264' and @ind2 = '1']/subfield[@code = 'c']">
                        <xsl:value-of select="datafield[@tag = '264' and @ind2 = '1']/subfield[@code = 'c']"/>                     
                </xsl:when>
            </xsl:choose>
            <xsl:text>&#xa;</xsl:text>
        </xsl:for-each>
