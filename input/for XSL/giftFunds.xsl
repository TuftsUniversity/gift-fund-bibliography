        ...
        <xsl:for-each select="record">
            ...
            <xsl:choose>
                <xsl:when test="datafield[@tag = '100']/subfield[@code = 'e']">
                    <xsl:value-of select="datafield[@tag = '100']/subfield[@code = 'e']"/>
                </xsl:when>
            </xsl:choose>
            <xsl:text>~</xsl:text>
            <xsl:choose>
            ...
            <xsl:choose>
                <xsl:when test="datafield[@tag = '110']/subfield[@code = 'e']">
                    <xsl:value-of select="datafield[@tag = '110']/subfield[@code = 'e']"/>
                </xsl:when>
            </xsl:choose>
            <xsl:text>~</xsl:text>
            <xsl:choose>
            ...
            <xsl:choose>
                <xsl:when test="datafield[@tag = '700']/subfield[@code = 'e']">
                    <xsl:value-of select="datafield[@tag = '700']/subfield[@code = 'e']"/>
                </xsl:when>
            </xsl:choose>
            <xsl:text>~</xsl:text>
            <xsl:choose>
            ...
            <xsl:text>~</xsl:text>
            <xsl:choose>
                <xsl:when test="datafield[@tag = '981']/subfield[@code = 'b']">
                    <xsl:value-of select="datafield[@tag = '981']/subfield[@code = 'b']"/>
                </xsl:when>
            </xsl:choose>
            <xsl:text>&#xa;</xsl:text>
        </xsl:for-each>
